...
int main()
{
    ...
    // the cuda simulator
    CUDANBodySimulator cudaSimulator(particleSystem, physicsTimeStep);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        bool galaxyRegenerated = menu.renderMenu(particles, particleSystem, seqSimulator, bhSimulator, cudaSimulator);
        ...
        if (galaxyRegenerated)
        {
            ...
            cudaSimulator = CUDANBodySimulator(particleSystem, physicsTimeStep);
        }
